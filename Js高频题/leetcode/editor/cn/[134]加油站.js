...
//</ul>
//<div><div>Related Topics</div><div><li>贪心</li><li>数组</li></div></div><br><div><li>👍 856</li><li>👎 0</li></div>
...
var canCompleteCircuit = function (gas, cost) {
  ...
  while (i < n) {
    ...
    if (cnt === n) {
      ...
      //如果从x到达y处时，油箱耗尽为负数，此时从xy之间任意位置开始都无法y处，
      // 所以，下一次i直接从cnt+i+1开始，因为只有唯一解，所以这样可以极大降低了复杂度
      i = i + cnt + 1;
    }
  }
  return -1;
