...
//</ul>
//<div><div>Related Topics</div><div><li>字典树</li><li>记忆化搜索</li><li>哈希表</li><li>字符串</li><li>动态规划</li><li>回溯</li></div></div><br><div><li>👍 569</li><li>👎 0</li></div>
...
var wordBreak = function (s, wordDict) {
  ...
  const dfs = (idx, word) => {
    if (idx === s.length) res.push(word)
    let curr = dicTree
    while (curr[s[idx]]){
      curr = curr[s[idx]]
      idx++
      if(curr.word){
        dfs(idx, word==="" ? curr.word : word + ' ' +curr.word)
      }
    }
  }
